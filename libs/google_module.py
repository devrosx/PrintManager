...
def convert_doc_to_pdf(doc_file_path):
    folder = os.path.dirname(doc_file_path)
    ...
    pdf_file_path = os.path.join(folder, f"{file_name_without_ext}.pdf")   # Add .pdf extension
...
if __name__ == '__main__':
    ...
    doc_file_path = '/Users/mac/Desktop/test.docx'  # Replace with your file path
